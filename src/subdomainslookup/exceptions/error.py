...
class SubdomainsLookupApiError(Exception):
...
class ParameterError(SubdomainsLookupApiError):
    pass


class EmptyApiKeyError(SubdomainsLookupApiError):
    pass


class ResponseError(SubdomainsLookupApiError):
    def __init__(self, message):
        self.message = message
...
class UnparsableApiResponseError(SubdomainsLookupApiError):
...
class HttpApiError(SubdomainsLookupApiError):
    pass
